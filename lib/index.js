...
const swaggerUiPath = require('@leisurelink/swagger-ui/index').dist
...
const optionsSchema = Joi.object({
  ...
  swaggerOptions: Joi.object({
    ...
    apisSorter: Joi.alternatives().try(Joi.array().items(Joi.string()), Joi.string().allow(null).valid(['none', 'alpha'])).optional(),
    ...
    suppressTagNameInTagGroupHeader: Joi.boolean().optional(),
    infoOverride: Joi.object({
